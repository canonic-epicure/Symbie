declare( 'Ext::ux::widgets::DataViewContainer', function (use, checkState, __PACKAGE__){
 
	Ext.ux.widgets.DataViewContainer = Ext.extend(Ext.Container, {
	    /**
	    ...
	    initComponent : function(){
	        Ext.ux.widgets.DataViewContainer.superclass.initComponent.call(this);
	    ...
	    onRender : function(){
	        ...
	        Ext.ux.widgets.DataViewContainer.superclass.onRender.apply(this, arguments);
	    },
	
	    // private
	    afterRender : function(){
	        Ext.ux.widgets.DataViewContainer.superclass.afterRender.call(this);
	    ...
	    onDestroy : function(){
	        Ext.ux.widgets.DataViewContainer.superclass.onDestroy.call(this);
	        this.setStore(null);
	    }
	});
