Class('Symbie.Dispatcher', {
    
    use : [ 'Symbie.Dispatcher.Request' ],
    
    has : {
        application : null,
        
        requestClass : function () { return Symbie.Dispatcher.Request }
    },
    
    
    methods : {
        
        //path, callback, scope, $params, root
        dispatch : function (options) {
            ...
            var request = new this.requestClass(options)
            
            this.prepareClasses(request)
        },
        
        
        prepareClasses : function (request) {
            request.prepareClasses(this.instantiate, this, [ request ])
        },
        
        
        instantiate : function (request) {
            request.instantiate(this.activate, this, [ request ])
        },
        
        
        activate : function (request) {
            request.activate(this.finalize, this, [ request ])
        },
