...
Ext.ux.StarSlider = Ext.extend(Ext.BoxComponent, {	
    minValue: 0,
    maxValue: 100,
    keyIncrement: 1,
    increment: 1,
    ...
    initComponent : function(){
        ...
        Ext.ux.StarSlider.superclass.initComponent.call(this);
    ...
    onRender : function(){
        ...
        Ext.ux.StarSlider.superclass.onRender.apply(this, arguments);
    ...
    afterRender : function(){
        Ext.ux.StarSlider.superclass.afterRender.apply(this, arguments);
        if(this.value !== undefined){
...
Ext.reg('starslider', Ext.ux.StarSlider);
...
Ext.form.StarRate = Ext.extend(Ext.form.Field, {
	...
	Ext.apply(this.starConfig, {
        ...
        this.star = new Ext.ux.StarSlider(this.starConfig);
