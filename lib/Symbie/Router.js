Class('Symbie.Router', {
    ...
    metaRoles : 'Symbie.Router.Builder',
    
    has : {
        application     : { init : null, required : true },
//        dispatcher      : { init : null, required : true },
    ...
    after : {
        initialize : function () {
            var draw = this.drawFunc
            
            if (!draw) throw "Draw not supplied"
